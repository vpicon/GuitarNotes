...
\end{enumerate}
It is also useful to know the specific distance (in terms of tones or semitones) of some (if not all!) intervals.
\begin{center}
\def\arraystretch{1.3} % vertical padding in the table
\begin{tabular}{| c | c |}
	\hline
	\textbf{Interval} & \textbf{Distance} \\ \hline
	Major \cardinal{2}{nd} & $1$ T \\ \hline
	Minor \cardinal{3}{rd} & $1+\sfrac{1}{2}$ T \\ \hline
	Major \cardinal{3}{rd} & $2$ T \\ \hline
	Perfect \cardinal{4}{th} & $2+\sfrac{1}{2}$ T \\ \hline
	\textit{Tritone} & 3 T \\ \hline
	Perfect \cardinal{5}{th} & $3+\sfrac{1}{2}$ T \\ \hline
	Perfect \cardinal{8}{th} & $6$ T \\ \hline
\end{tabular}
\end{center}

The special name \textit{tritone} is given to the Augmented \cardinal{4}{th} (or Diminished \cardinal{5}{th}) interval, a special interval which will be covered in depth in future sections.
